...
namespace BuscaHotel_HotelAPI.Migrations
{
    ...
    [Migration("20230326003927_addUsersToDb")]
            ...
            modelBuilder.Entity("BuscaHotel_HotelAPI.Models.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataCriacao = new DateTime(2023, 3, 25, 21, 39, 27, 34, DateTimeKind.Local).AddTicks(2734),
                        ...
                        new
                        {
                            ...
                            Area = 900,
                            DataAtualizacao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataCriacao = new DateTime(2023, 3, 25, 21, 39, 27, 34, DateTimeKind.Local).AddTicks(2907),
                        ...
                        new
                        {
                            ...
                            Area = 750,
                            DataAtualizacao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataCriacao = new DateTime(2023, 3, 25, 21, 39, 27, 34, DateTimeKind.Local).AddTicks(2918),
                        ...
                        new
                        {
                            ...
                            Area = 800,
                            DataAtualizacao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataCriacao = new DateTime(2023, 3, 25, 21, 39, 27, 34, DateTimeKind.Local).AddTicks(2920),
                        ...
                        new
                        {
                            ...
                            Area = 400,
                            DataAtualizacao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataCriacao = new DateTime(2023, 3, 25, 21, 39, 27, 34, DateTimeKind.Local).AddTicks(2921),
