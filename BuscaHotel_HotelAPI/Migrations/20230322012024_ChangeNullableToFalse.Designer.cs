...
namespace BuscaHotel_HotelAPI.Migrations
{
    ...
    [Migration("20230322012024_ChangeNullableToFalse")]
            ...
            modelBuilder.Entity("BuscaHotel_HotelAPI.Models.Hotel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataCriacao = new DateTime(2023, 3, 21, 22, 20, 24, 704, DateTimeKind.Local).AddTicks(5767),
                        ...
                        new
                        {
                            ...
                            Area = 900,
                            DataAtualizacao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataCriacao = new DateTime(2023, 3, 21, 22, 20, 24, 704, DateTimeKind.Local).AddTicks(5777),
                        ...
                        new
                        {
                            ...
                            Area = 750,
                            DataAtualizacao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataCriacao = new DateTime(2023, 3, 21, 22, 20, 24, 704, DateTimeKind.Local).AddTicks(5779),
                        ...
                        new
                        {
                            ...
                            Area = 800,
                            DataAtualizacao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataCriacao = new DateTime(2023, 3, 21, 22, 20, 24, 704, DateTimeKind.Local).AddTicks(5780),
                        ...
                        new
                        {
                            ...
                            Area = 400,
                            DataAtualizacao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DataCriacao = new DateTime(2023, 3, 21, 22, 20, 24, 704, DateTimeKind.Local).AddTicks(5782),
